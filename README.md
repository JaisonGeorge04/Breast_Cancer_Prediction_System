...
⚡ Real-Time Predictions — Interactive Streamlit interface for instant, user-driven predictions
☁️ Cloud-Based Model Storage — Trained model artifacts stored securely in AWS S3 for easy updates and retrieval
